...
const Calculator = () => {
  ...
  return (
    <main className="w-screen h-screen bg-offwhite grid place-items-center">
      <section className="bg-white w-11/12 px-4 py-7 rounded-tl-2xl rounded-tr-2xl rounded-bl-2xl rounded-br-[5rem] sm:w-[500px] sm:px-8 sm:py-9 md:w-[600px] md:px-10 lg:w-[55%] xl:w-[650px] xl:py-12 lg:rounded-br-[7rem] lg:rounded-tr-3xl lg:rounded-tl-3xl lg:rounded-bl-3xl">
