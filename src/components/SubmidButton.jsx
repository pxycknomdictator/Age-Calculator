...
const SubmidButton = () => {
  ...
  return (
    <div className="relative mt-14 mb-16 md:static md:mt-14 md:mb-0 md:flex">
      ...
      <div
        onClick={SubmitData}
        className="bg-purple rounded-full w-14 h-14 p-3 cursor-pointer hover:bg-black transition-all absolute duration-300 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 md:static md:w-[60px] xl:w-[70px] xl:h-[65px]"
      >
